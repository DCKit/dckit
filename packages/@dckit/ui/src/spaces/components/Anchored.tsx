...
export const LeftResizable: React.FC<Omit<IAnchorProps, 'resizable'>> = ({
  children,
  size,
  ...props
}) => (
...
export const Left: React.FC<IAnchorProps> = ({
  size,
  children,
  resizable,
  ...commonProps
...
export const TopResizable: React.FC<Omit<IAnchorProps, 'resizable'>> = ({
  children,
  size,
  ...props
}) => (
...
export const Top: React.FC<IAnchorProps> = ({
  size,
  children,
  resizable,
  ...commonProps
...
export const RightResizable: React.FC<Omit<IAnchorProps, 'resizable'>> = ({
  children,
  size,
  ...props
}) => (
...
export const Right: React.FC<IAnchorProps> = ({
  size,
  children,
  resizable,
  ...commonProps
...
export const BottomResizable: React.FC<Omit<IAnchorProps, 'resizable'>> = ({
  children,
  size,
  ...props
}) => (
...
export const Bottom: React.FC<IAnchorProps> = ({
  size,
  children,
  resizable,
  ...commonProps

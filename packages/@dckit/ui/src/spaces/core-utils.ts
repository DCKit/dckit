...
export function styleDefinition(space: ISpaceDefinition) {
  ...
  if (space.canResizeLeft) {
    cssElements.push(
      `#${space.id}-t { left: calc(${css(space.left, true)} + ${css(
        space.width,
        true
      )} - 15px); }`
    )
    cssElements.push(
      `#${space.id}-m { left: calc(${css(space.left, true)} + ${css(
        space.width,
        true
      )} - 1px); }`
    )
  ...
  if (space.canResizeTop) {
    cssElements.push(
      `#${space.id}-t { top: calc(${css(space.top, true)} + ${css(
        space.height,
        true
      )} - 15px); }`
    )
    cssElements.push(
      `#${space.id}-m { top: calc(${css(space.top, true)} + ${css(
        space.height,
        true
      )} - 1px); }`
    )
  ...
  if (space.canResizeRight) {
    cssElements.push(
      `#${space.id}-t { right: calc(${css(space.right, true)} + ${css(
        space.width,
        true
      )} - 15px); }`
    )
    cssElements.push(
      `#${space.id}-m { right: calc(${css(space.right, true)} + ${css(
        space.width,
        true
      )} - 1px); }`
    )
  ...
  if (space.canResizeBottom) {
    cssElements.push(
      `#${space.id}-t { bottom: calc(${css(space.bottom, true)} + ${css(
        space.height,
        true
      )} - 15px); }`
    )
    cssElements.push(
      `#${space.id}-m { bottom: calc(${css(space.bottom, true)} + ${css(
        space.height,
        true
      )} - 1px); }`
    )
